...
int main() {
    ...
    printf("6. Sair\n");
    printf("\n");
    printf("*** ESCOLHA UMA OPÇÃO ACIMA PARA A DISPUTA DO PRIMEIRO ATRIBUTO!: ***  \n");
    scanf("%d", &opcao1);
    printf("\n");
...
// Menu dinâmico: retirar a opção já escolhida
